...
def preprocess_data(df):
    ...
    text_features = ['RequestURIPath', 'RequestURIQuery', 'RequestBody', 'UserAgent'] # Corrected 'agent' to 'UserAgent'
    ...
    preprocessor = ColumnTransformer(
        transformers=[
            ...
            ('text_user_agent', TfidfVectorizer(max_features=5000, analyzer='char', ngram_range=(2, 4)), 'UserAgent'), # Changed to char-level as well
